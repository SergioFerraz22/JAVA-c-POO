...
import java.awt.FlowLayout;  // os gerenciadores de Layout estão nessa biblioteca
import javax.swing.*;
public class Exemplo3 {
    ...
    public static void main(String args[ ]) {
        ...
        JFrame janela = new JFrame("Interface Gráfica com Swing - versão 03");
        ...
        janela.getContentPane().setLayout(new FlowLayout()); // especificação do gerenciador                                                             // de layout
